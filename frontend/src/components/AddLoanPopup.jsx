    ...
    >
      ...
      <div className="modal modal-sm" style={{ zIndex: 11 }}>
        ...
        <div className="modal-title">
          {editLoan ? 'Update' : 'Record'} Commitment
        </div>
        <div className="modal-sub">
          {editLoan
            ? 'Modify existing lending/borrowing details.'
            : 'Track personal lending & borrowing.'}
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-tabs">
            <div
              ...
              style={{
                color: loanType === 'LENT' ? 'var(--green)' : undefined,
              }}
            ...
            <div
              ...
              style={{
                color: loanType === 'BORROWED' ? 'var(--red)' : undefined,
              }}
          ...
          <div className="modal-actions">
            ...
            <button
              ...
              className="btn-save"
              style={{
                background: loanType === 'LENT' ? 'var(--green)' : 'var(--red)',
              }}
              disabled={loading}
            >
              {loading
