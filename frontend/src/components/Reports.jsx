...
const Reports = () => {
  ...
  const getActivePeriodLabel = () =>
    periods.find((p) => p.id === period)?.label || 'Monthly';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="card-header border-b border-border pb-4 mb-6">
            ...
            <div className="flex items-center gap-4 text-[10px] uppercase tracking-wider font-bold">
              ...
              {(activeTab === 'Overview' ||
                ...
                activeTab === 'Cash Flow') && (
                <div className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-red opacity-70"></span>{' '}
                  Expense
                </div>
              )}
              {activeTab === 'Savings' && (
            ...
            <ResponsiveContainer width="100%" height="100%">
              {activeTab === 'Savings' ? (
                ...
                >
                  ...
                  <Area
                    type="monotone"
                    dataKey={(val) => val.income - val.expense}
                    name="Savings"
                    stroke="var(--purple)"
                    fillOpacity={1}
        ...
        activeTab === 'Expense' ? (
          ...
          <div className="card h-full flex flex-col p-8 items-center justify-center text-center">
            ...
            <p className="text-sm text-text2 max-w-[280px]">
              Detailed category breakdowns are available in the Income and
              Expense tabs. Use this view to monitor net performance.
            </p>
          </div>
        )}
      </div>
