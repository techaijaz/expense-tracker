  ...
  return (
    <div className="settings-card">
      <div className="settings-section-title">
        <div className="icon">🌍</div>Regional Specs
      </div>
      ...
      <div className="settings-row">
        <div>
          ...
          <div className="settings-val">
            System-wide default for ledger entries
          </div>
        </div>
        <select
          value={currency}
      ...
      <div className="settings-row">
        <div>
          ...
          <div className="settings-val">
            Sets default calling code and currency context
          </div>
        </div>
        <select
          value={country}
      ...
      <div className="settings-row">
        ...
        >
          ...
          {!Country.getCountryByCode(country)?.timezones.some(
