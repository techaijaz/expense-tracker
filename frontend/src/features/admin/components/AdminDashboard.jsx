    ...
    return (
      <div className="p-8 text-center bg-[var(--glass-bg)] backdrop-blur-md border border-[var(--border)] rounded-2xl mx-6 mt-6">
        ...
        <p className="text-text2">
          Failed to load statistics. Please check your connection or contact
          dev-ops.
        </p>
      </div>
    );
  ...
  return (
    <div className="page-body space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-text2 text-sm max-w-2xl">
          Real-time surveillance of ecosystem health, user growth, and financial
          throughput.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--glass-bg)] backdrop-blur-md border border-[var(--border)] rounded-[var(--r3)] p-5 relative overflow-hidden">
          <div className="card-header">
            <div>
              <h3 className="card-title uppercase tracking-widest text-[11px] text-accent">
                Registration Pulse
              </h3>
        ...
        <div className="bg-[var(--glass-bg)] backdrop-blur-md border border-[var(--border)] rounded-[var(--r3)] p-5">
          <div className="card-header">
            <div>
              <h3 className="card-title uppercase tracking-widest text-[11px] text-purple">
                Global Node Matrix
              </h3>
              <p className="card-sub">
                User distribution by geographical sector
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="text-center">
                  <div className="text-[10px] uppercase tracking-widest text-text3 font-bold">
                    Total
                  </div>
