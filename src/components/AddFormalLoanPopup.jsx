  ...
  return (
    <div className="modal-overlay">
      ...
      <div className="modal" style={{ zIndex: 11, maxWidth: '560px' }}>
        ...
        <div className="modal-sub">Calculate EMI and track your formal debt schedule.</div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-grid">
            <div className="form-group" style={{ gridColumn: 'span 2' }}>
              ...
              />
              {errors.bankName && <p className="error-msg">{errors.bankName.message}</p>}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.principal && <p className="error-msg">{errors.principal.message}</p>}
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="8.5"
              />
              {errors.interestRate && <p className="error-msg">{errors.interestRate.message}</p>}
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="60"
              />
              {errors.tenureMonths && <p className="error-msg">{errors.tenureMonths.message}</p>}
            </div>
            ...
            <div className="form-group">
              ...
              <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                ...
                <PopoverContent className="w-auto p-0 z-[1000]" align="start" style={{ backgroundColor: 'var(--bg3)', border: '1px solid var(--border)' }}>
                  <Calendar
                    mode="single"
                    selected={startDate}
                    onSelect={(d) => {
            ...
            <div className="form-group">
              <label className="form-label">Disbursement Account (Optional)</label>
              <select {...register('associatedAccountId')} className="form-input">
          ...
          <div style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 'var(--r)', padding: '16px', margin: '20px 0' }}>
            <div style={{ fontSize: '11px', color: 'var(--text3)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600, marginBottom: '12px' }}>
              Loan Summary
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '11px', color: 'var(--text2)', marginBottom: '4px' }}>Monthly EMI</div>
                <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--accent)', fontFamily: 'var(--mono)' }}>
                  {formatAmount(calculation.emi, currency, decimalPlaces)}
                </div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '11px', color: 'var(--text2)', marginBottom: '4px' }}>Total Interest</div>
                <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--amber)', fontFamily: 'var(--mono)' }}>
                  {formatAmount(calculation.totalInterest, currency, decimalPlaces)}
                </div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '11px', color: 'var(--text2)', marginBottom: '4px' }}>Total Payable</div>
